// src/infrastructure/passport-google.ts
...
// --- CAMBIO AQUÍ: Extraemos las variables primero para verificar si existen ---
const clientID = process.env.GOOGLE_CLIENT_ID;
const clientSecret = process.env.GOOGLE_CLIENT_SECRET;
const callbackURL = process.env.GOOGLE_CALLBACK_URL;

// Solo registramos la estrategia si tenemos las credenciales.
// Si estamos en TEST y no existen estas variables, el código simplemente se salta este bloque
// y evita el error "TypeError: OAuth2Strategy requires a clientID option".
