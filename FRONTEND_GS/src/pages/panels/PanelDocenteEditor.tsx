...
export default function PanelDocenteEditor() {
  const idCurso = "1"; // Ejemplo temporal
      ...
      <button className="mt-4 border border-[#7E3132] text-[#7E3132] rounded-md px-4 py-1 text-sm hover:bg-[#7E3132] hover:text-white transition-all">
        ...
        <div className="flex flex-col gap-6 w-[600px]">
          ...
          onClick={() => setIsModalOpen(true)}> 
            ...
            >
              <p>
                El período de edición del curso todavía no ha comenzado. Podrás añadir tópicos,
                evaluaciones y diagnósticos cuando el administrador lo habilite.
              </p>
            </Modal>
