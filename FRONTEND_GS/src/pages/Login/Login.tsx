...
export default function Login() {
  ...
  return (
    <section className="max-w-md mx-auto bg-white rounded-2xl border border-neutral-400 p-12 shadow-xl">
      <h1 className="text-l text-stone-800 font-bold mb-0 text-center">
        Bienvenido al Club
      </h1>
      <h1 className="text-xl text-[#7E3132] font-bold mb-3 text-center">
        INICIAR SESIÓN
      </h1>
      ...
      <form className="space-y-3" onSubmit={enviar}>
        <div>
          ...
          <input
            ...
            className="w-full border border-stone-600 rounded-lg px-3 py-2 outline-none"
            value={correo}
        ...
        <div className="flex flex-col mb-4 relative">
          ...
          <div className="relative">
            <input
              ...
              className="w-full border border-stone-600 rounded-lg px-3 py-2 pr-12 outline-none"
              value={contrasena}
        ...
        <div className="flex justify-center">
          <button
            type="submit"
            className="w-5/6 rounded-lg px-4 py-2 bg-[#7E3132] text-white hover:bg-[#712C2D]"
            disabled={cargando}
          >
      ...
      <button
        ...
        type="button"
        className="flex items-center justify-center w-5/6 mx-auto rounded-lg px-4 py-2 bg-white text-stone-600 border border-stone-400 hover:bg-stone-200"
      >
      ...
      <p className="text-sm text-gray-600 text-center mt-4">
        ...
        <Link
          to="/registro"
          className="font-semibold text-[#7E3132] hover:text-[#712C2D]"
        >
          Regístrate
        </Link>
      </p>
